...
<title>AS-BED</title>
<link rel="stylesheet" type="text/css" href="{{ asset('mobile/frontend/styles/bootstrap.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('mobile/frontend/styles/style.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('mobile/frontend/fonts/css/fontawesome-all.min.css') }}">
...
<div id="page">
    ...
    <div class="header header-fixed header-auto-show header-logo-app">
        <a href="index.html" class="header-title">AS-BED</a>
    ...
    <div class="page-content" style="margin-top:50px;">
                    ...
                    <div class="row mt-3 pt-1 mb-3">
                        <div class="col-6">
                            <i class="float-left ml-3 mr-3"
                               ...
                               data-feather-color="orange1-dark"
                               data-feather-bg="orange1-fade-light">
                            </i>
                            <h5 class="color-black float-left font-13 font-500 line-height-s pb-3 mb-3">Motivasi<br>Harian</h5>
                        </div>
                        <div class="col-6">
                            <i class="float-left ml-3 mr-3"
                            ...
                            <h5 class="color-black float-left font-13 font-500 line-height-s pb-3 mb-3">Panduan<br>Pemulihan</h5>
                        </div>
                        <div class="col-6">
                            <i class="float-left ml-3 mr-3"
        ...
        <div class="card card-style preload-img" data-src="images/pictures/bed5.jpg">
            <div class="card-body">
                ...
                <a href="#" class="btn btn-full bg-highlight font-600 rounded-sm text-uppercase">Temukan Inspirasi</a>
            </div>
        ...
        <div class="card card-style text-center">
            <div class="content pb-2">
                ...
                <a href="#" class="btn btn-center-xl btn-m text-uppercase font-900 bg-highlight rounded-sm shadow-l">Dapatkan Bantuan Sekarang</a>
            </div>
        </div>
...
<script type="text/javascript" src="{{ asset('mobile/frontend/scripts/jquery.js') }}"></script>
<script type="text/javascript" src="{{ asset('mobile/frontend/scripts/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('mobile/frontend/scripts/custom.js') }}"></script>
</body>
