...
<head>
    ...
    <link rel="manifest" href="{{ asset('mobile/_manifest.json') }}_manifest.json" data-pwa-version="set_in_manifest_and_pwa_js">
    ...
    <div id="page">
        ...
        <div id="menu-install-pwa-android" class="menu menu-box-bottom menu-box-detached rounded-l" data-menu-height="350" data-menu-effect="menu-parallax">
            <div class="boxed-text-l mt-4">
                ...
                <h4 class="mt-3">asbed on your Home Screen</h4>
                <p>Install asbed on your home screen, and access it just like a regular app. It really is that simple!</p>
        ...
        <div id="menu-install-pwa-ios" class="menu menu-box-bottom menu-box-detached rounded-l" data-menu-height="320" data-menu-effect="menu-parallax">
            <div class="boxed-text-xl mt-4">
                <img class="rounded-l mb-3" src="app/icons/icon-128x128.png" alt="img" width="90">
                <h4 class="mt-3">asbed on your Home Screen</h4>
                <p class="mb-0 pb-3">Install asbed on your home screen, and access it just like a regular app. Open your Safari menu and tap "Add to Home Screen".</p>
                <div class="clear"></div>
