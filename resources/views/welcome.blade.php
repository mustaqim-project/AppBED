...
<body>
    <form action="{{ url('/') }}" method="GET">
        ...
        <select name="lang" id="lang" onchange="this.form.submit()">
            ...
            <option value="zh-CN" {{ session('lang') == 'zh-CN' ? 'selected' : '' }}>Mandarin</option>
            <option value="es" {{ session('lang') == 'es' ? 'selected' : '' }}>Español</option>
            <option value="ru" {{ session('lang') == 'ru' ? 'selected' : '' }}>Русский</option>
            <option value="ar" {{ session('lang') == 'ar' ? 'selected' : '' }}>العربية</option>
            <option value="fr" {{ session('lang') == 'fr' ? 'selected' : '' }}>Français</option>
            <option value="de" {{ session('lang') == 'de' ? 'selected' : '' }}>Deutsch</option>
            <option value="ja" {{ session('lang') == 'ja' ? 'selected' : '' }}>日本語</option>
            <option value="ko" {{ session('lang') == 'ko' ? 'selected' : '' }}>한국어</option>
        </select>
    </form>
